...
export function ThemePresetButtons({
  ...
  const rowsData = Array.from({ length: numRows }, (_, index) => createRowProps(index)).filter(
    Boolean
  );
  ...
  return (
    ...
    <motion.div
      ...
      className="overview-hidden -my-2 mb-8 flex w-full flex-col py-2"
      style={{
        gap: `${rowGapPx}px`,
        maskImage:
    ...
    >
      {rowsData.map((rowData) => (
        <AnimatedRow key={rowData!.key} target={rowData!.animate} options={rowData!.transition}>
          {/* Inner div for spacing when using justify-content */}
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2.5 text-center">
                      ...
                      <div className="px-1 leading-tight capitalize">
